...
namespace APATools.Controllers.State
{
    public class StateReportController : Controller
    {
        ...
        public  async Task<IActionResult> APA_MC_1_State()
        {
            ...
            {
                var allowDistrict = new List<long> { 664, 311, 310, 704, 703, 313, 305 };
        ...
        public  IActionResult APA_Total_Entry_Count_State()
        {
            var data = _context.Procedures.Sp_APA_Update_Count();
            if (data != null)
            {
                return View(data);
            }
        ...
        public IActionResult APA_Total_Entry_Count_by_GP_State()
        {
            var data = _context.Procedures.Sp_APA_Update_Count_by_GP();
            if (data != null)
            {
                return View(data);
            }

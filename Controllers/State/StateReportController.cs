...
{
    public class StateReportController : Controller
    {
        private readonly ILogger<StateReportController> _logger;
        private readonly APAToolsContext _context;
        private readonly IWebHostEnvironment _environment;
        public StateReportController(ILogger<StateReportController> logger, APAToolsContext context, IWebHostEnvironment environment)
        {
            _context = context;
            _logger = logger;
            _environment = environment;
        }
        public  async Task<IActionResult> APA_MC_1_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var user = HttpContext.Session.GetString("UserInfo");
                var query = from ap in _context.A_APA_MC_1s
                            ...
                            where dt.AllowCheck == 1 && ap.ActiveStatus != 99
                            orderby ap.GPCode
        ...
        public IActionResult APA_MC_2_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
        ...
        public IActionResult APA_MC_3_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_4_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_5_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_6_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_1_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_2_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_3_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_4_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_5_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_6_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_7_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_8_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_9_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_10_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_11_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_13_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_14_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_16_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_17_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_18_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_19_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_20_State()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "PMUAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public  async Task<IActionResult> APA_Total_Entry_Count_State()
        {
            var data = await _context.Procedures.Sp_APA_Update_CountAsync();
            if (data != null)
            {
                return View(data);
            }
        ...
        public async Task<IActionResult> APA_Total_Entry_Count_by_GP_State()
        {
            var data = await _context.Procedures.Sp_APA_Update_Count_by_GPAsync();
            if (data != null)
            {
                return View(data);
            }
        ...
        public async Task<IActionResult> CheckedCompletedGP()
        {
            if (HttpContext.Session.GetString("UserRole") == "4")
            {
                var query = await _context.Procedures.Sp_APA_Checked_Complete_GPAsync();
                ...
                {
                    return RedirectToAction("CheckedCompletedGP", "StateReport");
                }
            }
            else
            {

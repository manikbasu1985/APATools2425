...
namespace APATools.Controllers.District
{
    ...
    {
        private readonly ILogger<DistrictReportController> _logger;
        private readonly APAToolsContext _context;
        public DistrictReportController(ILogger<DistrictReportController> logger, APAToolsContext context)
        {
            _context = context;
            _logger = logger;
        }
        public IActionResult APA_MC_1_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                ...
                var data = from ap in _context.A_APA_MC_1s
                           ...
                           where loc.DistrictCode == accessID
        ...
        public IActionResult APA_MC_2_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_5_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_6_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_1_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_2_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_3_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_4_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_5_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_6_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_7_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_8_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_9_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_10_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_13_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_14_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_16_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_17_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_19_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_3_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_4_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_11_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_18_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_20_DCU()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = from ap in _context.A_APA_TE_20s
                           ...
                           select new APA_TE_20_Report
                           {
                               ...
                               GrievenceImage = ap.GrievenceImage,
                               GrievenceImage_Path = ap.GrievenceImage_Path,
                               ActiveStatus = ap.ActiveStatus
                           };
                return View(data);
            }
        ...
        //Edit Section
        public ActionResult APA_MC_1_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                ...
                return RedirectToAction("APA_MC_1_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
                return RedirectToAction("APA_MC_1_DCU", "DistrictReport");
            }
        }
        public ActionResult APA_MC_2_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_MC_2_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_MC_5_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_MC_5_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_MC_6_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_MC_6_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_1_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_1_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_10_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_10_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_11_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_11_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_13_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_13_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_14_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_14_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_16_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_16_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_17_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_17_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public async Task<IActionResult> APA_Total_Entry_Count_Blockwise()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "DistrictAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = await _context.Procedures.Sp_APA_Update_Count_BlockwiseAsync(accessID);
                if (data != null)
                {
                    return View(data);
                }
                ...
                {
                    TempData["Failed"] = "No Entry found";
                    return View();
                }
            }
            else
        ...
        /*public ActionResult APA_TE_18_DCU_Edit(int id)
        {
            var data = _context.A_APA_TE_18s.Where(q => q.ID == id).FirstOrDefault();
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_18_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_19_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_19_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_2_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_2_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_20_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_20_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_3_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_3_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_4_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_4_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_5_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_5_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_6_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_6_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_7_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_7_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_8_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_8_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";
        ...
        public ActionResult APA_TE_9_DCU_Edit(int id)
        {
            ...
            if (data != null)
            {
                data.ActiveStatus = 2;
                _context.SaveChanges();
                return RedirectToAction("APA_TE_9_DCU", "DistrictReport");
            }
            else
            {
                TempData["Failed"] = "Your select Data is not valid";

...
{
    public class GPReportController : Controller
    {
        private readonly ILogger<GPReportController> _logger;
        private readonly APAToolsContext _context;
        private readonly IWebHostEnvironment _environment;
        public GPReportController(ILogger<GPReportController> logger, APAToolsContext context, IWebHostEnvironment environment)
        {
            _context = context;
            _logger = logger;
            _environment = environment;
        }
        public IActionResult APA_MC_1_Report()
        {
        ...
        public IActionResult APA_MC_2_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_5_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                ...
                var gploc = _context.view_alllocations.Where(q => q.GPCode == accessID).FirstOrDefault();
                ViewBag.GPName = gploc.GPName;
                return View(data);
            }
            else
            {
        ...
        public IActionResult APA_MC_6_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_1_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_2_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_3_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_4_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_5_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = from ap in _context.A_APA_TE_5s
                           ...
                           select new APA_TE_5_Report
                           {
                               ...
                               FundofActivity_1 = ap.FundofActivity_1,
                               FundofActivity_2 = ap.FundofActivity_2,
                               FundofActivity_3 = ap.FundofActivity_3,
                               FundofActivity_4 = ap.FundofActivity_4,
                               FundofActivity_5 = ap.FundofActivity_5,
        ...
        public IActionResult APA_TE_6_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = from ap in _context.A_APA_TE_6s
                           ...
                           select new APA_TE_6_Report
                           {
                               ...
                               FundofActivity_1_MT = ap.FundofActivity_1_MT,
                               FundofActivity_2_MT = ap.FundofActivity_2_MT,
                               FundofActivity_3_MT = ap.FundofActivity_3_MT,
                               FundofActivity_4_MT = ap.FundofActivity_4_MT,
                               FundofActivity_5_MT = ap.FundofActivity_5_MT,
        ...
        public IActionResult APA_TE_7_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = from ap in _context.A_APA_TE_7s
                           ...
                           select new APA_TE_7_Report
                           {
                               ...
                               FundofActivity_1_AQT = ap.FundofActivity_1_AQT,
                               FundofActivity_2_AQT = ap.FundofActivity_2_AQT,
                               FundofActivity_3_AQT = ap.FundofActivity_3_AQT,
                               FundofActivity_4_AQT = ap.FundofActivity_4_AQT,
                               FundofActivity_5_AQT = ap.FundofActivity_5_AQT,
        ...
        public IActionResult APA_TE_8_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_9_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_10_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_13_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
                var data = from ap in _context.A_APA_TE_13s
                           ...
                           select new APA_TE_13_Report
                           {
                               ...
                               FundofActivity_1_CFCSFC = ap.FundofActivity_1_CFCSFC,
                               FundofActivity_2_CFCSFC = ap.FundofActivity_2_CFCSFC,
                               FundofActivity_3_CFCSFC = ap.FundofActivity_3_CFCSFC,
                               FundofActivity_4_CFCSFC = ap.FundofActivity_4_CFCSFC,
                               FundofActivity_5_CFCSFC = ap.FundofActivity_5_CFCSFC,
        ...
        public IActionResult APA_TE_14_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_16_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_17_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_19_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_3_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_MC_4_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_11_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_18_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
        ...
        public IActionResult APA_TE_20_Report()
        {
            if (HttpContext.Session.GetString("isLoggedIn") == "GPAdmin")
            {
                var accessID = Convert.ToInt32(HttpContext.Session.GetString("UserAccessID"));
